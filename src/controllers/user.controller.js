...
const registerUser = asyncHandler(async (req, res) => {
  ...
  const existedUser = User.findOne({ $or: [{ userName }, { email }] }); // dollar operator...the find one with $or returns the first document containing userName or email
  if (existedUser) {
